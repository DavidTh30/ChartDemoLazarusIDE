...
var
  ChartSeries_:TBasicChartSeries;
begin
  if (LeftIndex_ < 0) and ( not MouseDown_) then begin MouseDownLeftIndex:=-1; exit; end;
  ...
  if ( not MouseDown_) then  begin MouseDownLeftIndex:=-1; exit; end;
...
begin
  ...
  if LeftIndex_ <0 then
  Label5.Caption:='Index Step : ';

  if MouseDownSeries >=0 then
  Label5.Caption:='Index Step : ' + FloatToStr(MouseDownSeriesStep);
